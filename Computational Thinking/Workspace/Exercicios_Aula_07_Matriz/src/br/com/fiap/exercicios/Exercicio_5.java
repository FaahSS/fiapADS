...
public class Exercicio_5 {
	public static void main(String[] args) {
		...
		for(int i=0;i<4;i++) {
			...
			System.out.println("--- Estoque no armazém ( "+(i+1)+" ): "+ qtd[i]);
		}
		...
		System.out.println("--- Armazém ( "+indiceMaior+" ) - Quantidade em estoque: "+numMaior);
		...
		System.out.println("--- Armazém ( "+indiceMenor+" ) - Quantidade em estoque: "+numMenor);
		...
		System.out.println("");
		System.out.println("---------- CUSTO TOTAL DE CADA ARMÁZEM -----------");
		for(int i=0;i<4;i++) {
			custoTotalArmazem=0;
			for(int j=0;j<3;j++) {

...
public class Main {
	...
	public static void main(String [] args) {
		...
		if (email.indexOf("@")<2) { // <2 é relacionado a relação da posição do @
			System.out.println("E-mail Inválido");
		}
		System.out.println(email.substring(0,email.indexOf("@"))); //Mostra todos os valores antes do indexof
		System.out.println(email.substring(email.indexOf("@"), email.length())); //funciona apagando o length também dali para frente		
